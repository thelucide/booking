<section role="main" class="content-body" id="service_group_add">
						...
						<div class="col-md-6 col-lg-12 col-xl-6">
							<section class="panel">
								...
								<div class="panel-body">
										<form id="service_group_add_form" action="Registration/service_group_insert/" class="form-horizontal form-bordered" autocomplete="off">
