	...
	<section role="main" class="content-body" id="service_group_list">
			...
			<div class="col-md-6 col-lg-12 col-xl-6">
				<section class="panel">
					...
					<div class="panel-body">
						...
						<table class="table table-bordered table-striped" id="datatable" data-url="registration/service_group_list_json/">
							<thead>
								<tr>
									<th width="5%">Sl</th>
