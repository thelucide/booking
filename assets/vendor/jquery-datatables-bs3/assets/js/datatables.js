(function (factory) {
	...
	$.fn.dataTableExt.oApi.fnPagingInfo = function ( oSettings )
	{
		...
		return {
			"iStart":         oSettings.json.cStart,
			"iEnd":          oSettings.json.cEnd,
			"iLength":       oSettings.json.cLength,
			"iTotal":         oSettings.json.iTotalRecords,
			"iFilteredTotal": oSettings.json.iTotalDisplayRecords,
			"iPage":          oSettings.json.cPage,
			"iTotalPages":    oSettings.json.cTotalPage
...
//console.log(oSettings.json.cPage);
